...
public class GetPatternStatsDemo {
     ...
     */ 
        ...
        //Use it to get stats for a single pattern or midi file
        ...
        System.out.println("Pitch average: " + pitchStatistics.getAverage()); //Average is always (mean - min)
        ...
        System.out.println("Pitch average: " + pa.getPitchStats().getAverage());
        ...
        System.out.println("Interval average difference:  " + intervalStats.getAverage());
