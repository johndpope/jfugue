...
public class DefaultPreprocessorFunctionTest extends JFugueTestHelper {
    ...
    public void testDefaultOctaveAndAttack() {
    	assertTrue(compare(":DEFAULT(OCTAVE=6,ATTACK=60) C", NOTE_PARSED, new Note(72).setAttackVelocity((byte)60)));
    }

	@Test
    public void testDefaultAttackAndDecay() {
    	assertTrue(compare(":DEFAULT(ATTACK=60,DECAY=80) C", NOTE_PARSED, new Note(60).setAttackVelocity((byte)60).setDecayVelocity((byte)80)));
    }
	...
	public void tearDown() {
		parser.preprocess(":DEFAULT(Duration="+DefaultManager.DEFAULT_DEFAULT_DURATION+
				",Octave="+DefaultManager.DEFAULT_DEFAULT_OCTAVE+
				",Bass_Octave="+DefaultManager.DEFAULT_DEFAULT_BASS_OCTAVE+
				",Attack="+DefaultManager.DEFAULT_DEFAULT_ATTACK_VELOCITY+
				",Decay="+DefaultManager.DEFAULT_DEFAULT_DECAY_VELOCITY+
				")");
	}
}
