...
public class KeyTest 
{
    ...
    public void testCreateMajorKeyByString() {
        ...
        assertTrue(key.getRootNote().getOriginalString().equals("A"));
    ...
    public void testCreateKeyBySignature1() {
        Key key = new Key("K####");
        assertTrue(key.getKeySignature().equalsIgnoreCase("BMAJ"));
        assertTrue(key.getRootNote().getOriginalString().equals("B"));
        assertTrue(key.getScale().equals(Scale.MAJOR));
    }
    ...
    public void testCreateKeyBySignature2() {
        Key key = new Key("Kb");
        assertTrue(key.getKeySignature().equalsIgnoreCase("Bmin"));
        assertTrue(key.getRootNote().getOriginalString().equals("B"));
        assertTrue(key.getScale().equals(Scale.MINOR));
    }
