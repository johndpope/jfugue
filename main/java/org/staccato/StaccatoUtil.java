...
public class StaccatoUtil 
{
   ...
   /**
    ...
    public static String createKeySignatureElement(byte key, byte scale) {
    	return SignatureSubparser.KEY_SIGNATURE + KeyProviderFactory.getKeyProvider().createKeyString(key, scale);
    }

    public static String createTimeSignatureElement(byte numerator, byte denominator) {
        return SignatureSubparser.TIME_SIGNATURE + numerator + numerator+SignatureSubparser.SEPARATOR + denominator;
    }
