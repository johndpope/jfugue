...
public class Rhythm implements PatternProducer
{
	...
	private TimeSignature timeSig; // TODO - Rhythm doesn't seem to use TimeSignature - is it important?
	private Map<Character, String> rhythmKit;
	private int length = 1;
	
	public Rhythm() {
		this(DEFAULT_TIME_SIGNATURE, DEFAULT_RHYTHM_KIT);
	}
	
	public Rhythm(String... layers) {
		this(DEFAULT_TIME_SIGNATURE, DEFAULT_RHYTHM_KIT, layers);
	}
	
	public Rhythm(TimeSignature timeSig, Map<Character, String> rhythmKit) {
    ...
    public Rhythm(TimeSignature timeSig, Map<Character, String> rhythmKit, String... layers) {
		this(timeSig, rhythmKit);
		for (String layer :  layers) {
			this.addLayer(layer);
		}
    }

    public Rhythm setTimeSignature(TimeSignature timeSig) {
    ...
    public Rhythm setLayers(List<String> layers) {
    	if (layers.size() > MAX_LAYERS) {
    		throw new RuntimeException("Size of the List<String> provided to Rhythm.setLayers() is greater than "+MAX_LAYERS);
    	}
    	this.layers = layers;
    	return this;
    }
    ...
    public Rhythm clone() {
    	return new Rhythm(this.timeSig, this.rhythmKit, this.getLayers().toArray(new String[0]));
    }
