...
public class DiagnosticParserListener implements ParserListener
{
    ...
    public void onTimeSignatureParsed(byte numerator, byte denominator) {
        print("Time signature parsed: "+numerator+"/"+denominator);
    }
    ...
    public void onNoteParsed(Note note) {
        print("Note parsed: value = "+note.getValue()+"  duration = "+note.getDuration()+"  attack = "+note.getAttackVelocity()+"  decay = "+note.getDecayVelocity());
    }

    @Override
    public void onChordParsed(Chord chord) {
        print("Chord parsed: rootnote = "+chord.getRoot().getValue()+"  intervals = "+chord.getIntervals().toString()+"  duration = "+chord.getRoot().getDuration()+"  attack = "+chord.getRoot().getAttackVelocity()+"  decay = "+chord.getRoot().getDecayVelocity());
    }
}
