...
public class Player 
{
	...
	public Sequence getSequence(String pattern) {
	...
	public void delayPlay(final long millisToDelay, final String pattern) {
		delayPlay(millisToDelay, getSequence(pattern));
	}
