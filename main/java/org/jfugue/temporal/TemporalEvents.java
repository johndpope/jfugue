...
public class TemporalEvents 
{
    ...
    public class TimeSignatureEvent implements TemporalEvent {
        private byte numerator, denominator;
        public TimeSignatureEvent(byte numerator, byte denominator) { this.numerator = numerator; this.denominator = denominator; }
        public void execute(Parser parser) { parser.fireKeySignatureParsed(numerator, denominator); }
    }
